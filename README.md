...
* [CMDER](https://cmder.net/) - Linha de comando simples, consegue rodar comands bash e Shell, alternativa ao Hyper no Windows.
* [JSONLint](https://jsonlint.com/) - Ferramenta Gratuita para validar seu JSON.
